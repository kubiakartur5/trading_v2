...
class BacktestEngine:
    def __init__(self, df: pd.DataFrame, initial_balance: float, leverage: float = 30.0, position_size: float = 100000):
    ...
    def run(self):
        for i in range(len(self.df)):
            ...
            # (Opcjonalnie) Logowanie stanu konta co 100 świec
            # if i % 100 == 0:
            #     print(f"[{current_time}] Equity: {self.wallet.equity:.2f} USD")
